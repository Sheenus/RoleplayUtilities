...
public class GuiSetRedstoneActivate extends GuiScreen {
	
	private final GuiScreen parentScreen;
	private GuiSetRedstoneActivateList setRedstoneActivateList;
	private final String title = I18n.format("reference.setredstoneactivate.title");
	private String template = I18n.format("reference.setredstoneactivate.template");
	
	protected GuiButton btnCopyTemplate;
	private boolean textCopied;
	
	public GuiSetRedstoneActivate(GuiScreen screen) {
    ...
    public void initGui() {
		...
		this.setRedstoneActivateList = new GuiSetRedstoneActivateList(this, this.mc);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.setRedstoneActivateList.drawScreen(mouseX, mouseY, partialTicks);
	...
	public void handleMouseInput() throws IOException {
        ...
        this.setRedstoneActivateList.handleMouseInput();
    }
	
	@Override
	protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
		this.setRedstoneActivateList.mouseClicked(mouseX, mouseY, mouseButton);
		super.mouseClicked(mouseX, mouseY, mouseButton);
	}
	
	@Override
	protected void mouseReleased(int mouseX, int mouseY, int state) {
		this.setRedstoneActivateList.mouseReleased(mouseX, mouseY, state);
