...
public class GuiPotionEffects extends GuiScreen {
	...
	private GuiPotionEffectsList potionEffectsList;
	private final String title = I18n.format("reference.potioneffects.title");
	private String template = I18n.format("reference.potioneffects.template");
	
	protected GuiButton btnCopyTemplate;
	private boolean textCopied;
	
	public GuiPotionEffects(GuiScreen screen) {
    ...
    public void initGui() {
		...
		this.potionEffectsList = new GuiPotionEffectsList(this, this.mc);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.potionEffectsList.drawScreen(mouseX, mouseY, partialTicks);
	...
	public void handleMouseInput() throws IOException {
        ...
        this.potionEffectsList.handleMouseInput();
    }
	
	@Override
	protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
		this.potionEffectsList.mouseClicked(mouseX, mouseY, mouseButton);
		super.mouseClicked(mouseX, mouseY, mouseButton);
	}
	
	@Override
	protected void mouseReleased(int mouseX, int mouseY, int state) {
		this.potionEffectsList.mouseReleased(mouseX, mouseY, state);
