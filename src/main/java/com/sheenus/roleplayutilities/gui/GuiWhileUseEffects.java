...
public class GuiWhileUseEffects extends GuiScreen {
	
	private final GuiScreen parentScreen;
	private GuiWhileUseEffectsList whileUseList;
	private final String title = I18n.format("reference.whileuseeffects.title");
	private String template = I18n.format("reference.whileuseeffects.template");
	
	protected GuiButton btnCopyTemplate;
	private boolean textCopied;
	
	public GuiWhileUseEffects(GuiScreen screen) {
    ...
    public void initGui() {
		...
		this.whileUseList = new GuiWhileUseEffectsList(this, this.mc);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.whileUseList.drawScreen(mouseX, mouseY, partialTicks);
	...
	public void handleMouseInput() throws IOException {
        ...
        this.whileUseList.handleMouseInput();
    }
	
	@Override
	protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
		this.whileUseList.mouseClicked(mouseX, mouseY, mouseButton);
		super.mouseClicked(mouseX, mouseY, mouseButton);
	}
	
	@Override
	protected void mouseReleased(int mouseX, int mouseY, int state) {
		this.whileUseList.mouseReleased(mouseX, mouseY, state);
