...
public class GuiWeaponEffects extends GuiScreen {
	
	private final GuiScreen parentScreen;
	private GuiWeaponEffectsList weaponEffectsList;
	private final String title = I18n.format("reference.weaponeffects.title");
	private String template = I18n.format("reference.weaponeffects.template");
	
	protected GuiButton btnCopyTemplate;
	private boolean textCopied;
	
	public GuiWeaponEffects(GuiScreen screen) {
    ...
    public void initGui() {
		...
		this.weaponEffectsList = new GuiWeaponEffectsList(this, this.mc);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.weaponEffectsList.drawScreen(mouseX, mouseY, partialTicks);
	...
	public void handleMouseInput() throws IOException {
        ...
        this.weaponEffectsList.handleMouseInput();
    }
	
	@Override
	protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
		this.weaponEffectsList.mouseClicked(mouseX, mouseY, mouseButton);
		super.mouseClicked(mouseX, mouseY, mouseButton);
	}
	
	@Override
	protected void mouseReleased(int mouseX, int mouseY, int state) {
		this.weaponEffectsList.mouseReleased(mouseX, mouseY, state);
