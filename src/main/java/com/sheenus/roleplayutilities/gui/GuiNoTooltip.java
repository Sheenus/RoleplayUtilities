...
public class GuiNoTooltip extends GuiScreen {
	
	private final GuiScreen parentScreen;
	private GuiNoTooltipList noTooltipList;
	private final String title = I18n.format("reference.notooltip.title");
	private String template = I18n.format("reference.notooltip.template");
	
	protected GuiButton btnCopyTemplate;
	private boolean textCopied;
	
	public GuiNoTooltip(GuiScreen screen) {
    ...
    public void initGui() {
		...
		this.noTooltipList = new GuiNoTooltipList(this, this.mc);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.noTooltipList.drawScreen(mouseX, mouseY, partialTicks);
	...
	public void handleMouseInput() throws IOException {
        ...
        this.noTooltipList.handleMouseInput();
    }
	
	@Override
	protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
		this.noTooltipList.mouseClicked(mouseX, mouseY, mouseButton);
		super.mouseClicked(mouseX, mouseY, mouseButton);
	}
	
	@Override
	protected void mouseReleased(int mouseX, int mouseY, int state) {
		this.noTooltipList.mouseReleased(mouseX, mouseY, state);
